...
class SingleStageDetector(BaseDetector):
    ...
    def simple_test(self, img, img_metas, rescale=False, gt_bboxes=None, gt_labels=None):
        ...
        if gt_bboxes == None and gt_labels == None:
            results_list = self.bbox_head.simple_test(
                feat, img_metas, rescale=rescale)
        else:
            kwargs = {'gt_bboxes': gt_bboxes, 'gt_labels': gt_labels}
            results_list = self.bbox_head.simple_test(
        ...
        # ]
        # return bbox_results, results_list[0][-1]
